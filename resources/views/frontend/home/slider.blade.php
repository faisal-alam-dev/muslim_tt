    ...
    <div class="main-slider swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="slider-one_image-layer" style="background-image:url({{ asset('frontend/assets/images/main-slider/1.jpg') }})"></div>
            ...
            <!-- Slide -->
            <div class="swiper-slide">
                <div class="slider-one_image-layer" style="background-image:url({{ asset('frontend/assets/images/main-slider/2.jpg') }})"></div>
                <div class="auto-container">
            ...
            <!-- Slide -->
            <div class="swiper-slide">
                <div class="slider-one_image-layer" style="background-image:url({{ asset('frontend/assets/images/main-slider/3.jpg') }})"></div>
                <div class="auto-container">
