<section class="service-one" style="background-image:url({{ asset('frontend/assets/images/background/service-bg.png') }})">
    <div class="auto-container">
        <!-- Sec Title -->
        <div class="sec-title centered light">
            <div class="sec-title_title">WHAT WE OFFER</div>
            <h2 class="sec-title_heading">We offer an effective <br> Muslim Tour & Travels packages</h2>
        </div>
