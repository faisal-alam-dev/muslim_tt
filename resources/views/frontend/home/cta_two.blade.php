<section class="cta-two">
    <div class="auto-container">
        <div class="inner-container d-flex justify-content-between align-items-center flex-wrap">
            <div class="cta-two_bg" style="background-image:url({{ asset('frontend/assets/images/background/cta-one_bg.png') }})"></div>
            ...
            <div class="cta-two_button">
                <a href="{{ route('frontend.contact.us') }}" class="theme-btn btn-style-three">
                    <span class="btn-wrap">
